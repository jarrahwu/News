...
public abstract class BaseItemAnimatorEx extends RecyclerView.ItemAnimator {
    ...
    public boolean animateChange(ViewHolder oldHolder, ViewHolder newHolder,
            int fromX, int fromY, int toX, int toY) {
        preAnimateChange(oldHolder, newHolder);
     ...
     * @param newHolder
     */
    protected void preAnimateChange(ViewHolder oldHolder, ViewHolder newHolder) {
